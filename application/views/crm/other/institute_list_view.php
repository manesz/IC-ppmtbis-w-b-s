    ...
    <div class="navbar">
        <div class="navbar-inner">
            <ul class="breadcrumb">
                ...
                <li class="active">สถาบันการศึกษา                </li>
            </ul>
        </div>
    </div>
</div>
<div class="row-fluid" id="contentInner">
    ...
    <div class="block">
        <div class="navbar navbar-inner block-header">
            <div class="muted pull-left">Institute List</div>
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="display" id="dataTable">
                ...
                foreach ($arrData as $key => $value):
                    ...
                    <tr class="<?php echo "odd_gradeX" ? $key % 2 == 0 : "odd_gradeA"; ?>">
                        ...
                        <td><?php echo $value->name_short; ?></td>
                        <td class="center"><?php echo $value->create_time; ?></td>
                        <td class="center">
                            <a class="editData" onclick="innerHtml('#add', '<?php echo $webUrl; ?>crm/instituteEdit/<?php echo $value->id; ?>');return false;"
                               href="<?php echo $webUrl; ?>cpanel/instituteEdit/<?php echo $value->id; ?>">
                                แก้ไข</a> /
                            <a class="deleteData" href="#"
                               onclick="return deleteClick('<?php echo $webUrl; ?>crm/instituteDelete/<?php echo $value->id; ?>')">ลบ</a>
                            <!--/ <a href="#">ดู</a>-->
                        </td>
                    </tr>
                <?php
