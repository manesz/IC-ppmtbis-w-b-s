...
<div class="row-fluid" id="contentInner">
    ...
    <div class="block">
        <div class="navbar navbar-inner block-header">
            ...
            <!--                <a id="buttonNew" href="--><?php //echo $webUrl; ?><!--crm/positionNew"><span-->
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="display" id="dataTable">
                ...
                foreach ($arrData as $key => $value):
                    ...
                    <tr class="<?php echo "odd_gradeX" ? $key % 2 == 0 : "odd_gradeA"; ?>">
                        ...
                        <td><?php echo $value->job_group_name; ?></td>
                        <td><?php echo $value->create_time; ?></td>
                        <td class="center">
                            <a class="editData" onclick="innerHtml('#add', '<?php echo $webUrl; ?>crm/positionEdit/<?php echo $value->int; ?>');return false;"
                               href="<?php echo $webUrl; ?>crm/positionEdit/<?php echo $value->int; ?>">
                                แก้ไข</a> /
                            <a class="deleteData" href="#"
                               onclick="return deleteClick('<?php echo $webUrl; ?>crm/positionDelete/<?php echo $value->int; ?>')">ลบ</a>
                            <!--/ <a href="#">ดู</a>-->
                        </td>
                    </tr>
                <?php
    ...
    <div class="block"><div id="add"></div></div>
    <!-- /block -->
</div>