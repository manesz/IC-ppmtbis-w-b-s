    ...
    <div class="navbar">
        <div class="navbar-inner">
            <ul class="breadcrumb">
                ...
                <li class="active">ระดับการศึกษา</li>
            </ul>
        </div>
    </div>
</div>
<div class="row-fluid" id="contentInner">
    ...
    <div class="block">
        <div class="navbar navbar-inner block-header">
            <div class="muted pull-left">Education Level List</div>
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="display" id="dataTable">
                ...
                foreach ($arrData as $key => $value):
                    ...
                    <tr class="<?php echo "odd_gradeX" ? $key % 2 == 0 : "odd_gradeA"; ?>">
                        ...
                        <td class="center">
                            <a class="editData" onclick="innerHtml('#add', '<?php echo $webUrl; ?>crm/educationLevelEdit/<?php echo $value->int ?>');return false;"
                               href="<?php echo $webUrl; ?>crm/educationLevelEdit/<?php echo $value->int; ?>">
                                แก้ไข</a> /
                            <a class="deleteData" href="#"
                               onclick="return deleteClick('<?php echo $webUrl; ?>crm/educationLevelDelete/<?php echo $value->int; ?>')">ลบ</a>
                            <!--/ <a href="#">ดู</a>-->
                        </td>
                    </tr>
                <?php
