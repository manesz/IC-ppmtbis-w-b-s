    ...
    <div class="navbar">
        <div class="navbar-inner">
            <ul class="breadcrumb">
                ...
                <li class="active">อายุการทำงาน                </li>
            </ul>
        </div>
    </div>
</div>
<div class="row-fluid" id="contentInner">
    ...
    <div class="block">
        <div class="navbar navbar-inner block-header">
            <div class="muted pull-left">Rang Salary List</div>
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="display" id="dataTable">
                ...
                foreach ($arrData as $key => $value):
                    ...
                    <tr class="<?php echo "odd_gradeX" ? $key % 2 == 0 : "odd_gradeA"; ?>">
                        ...
                        <td><?php echo $value->older_data; ?></td>
                        <td class="center"><?php echo $value->create_time; ?></td>
                        <td class="center">
                            <a class="editData" onclick="innerHtml('#add', '<?php echo $webUrl; ?>crm/rangSalaryEdit/<?php echo $value->id; ?>');return false;"
                               href="<?php echo $webUrl; ?>cpanel/rangSalaryEdit/<?php echo $value->id; ?>">
                                view</a> /
                            <!--<a class="deleteData" href="#"
                               onclick="return deleteClick('<?php echo $webUrl; ?>crm/rangSalaryDelete/<?php echo $value->id; ?>')">ลบ</a>-->
                            <!--/ <a href="#">ดู</a>-->
                        </td>
                    </tr>
                <?php
