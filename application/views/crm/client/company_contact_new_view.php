...
<script>
    $(document).ready(function () {
        $("#btnSave").click(function () {
            var url = "<?php echo $webUrl; ?>crm/companyContactNew/<?php echo $id?>";
...
<div class="block">
    <div class="navbar navbar-inner block-header">
        <div class="muted pull-left">เพิ่มรายการผู้ติดต่อประสานงาน</div>
    ...
    <div class="block-content collapse in">
        <form id="fancyFormPost" name="fancyFormPost" method="post" action="">
                ...
                <div class="span4">
                    <select name="position_id" id="position_id" class="input-block-level">
                        ...
                        <?php foreach($arrPosition as $key => $value): ?>
                            <option value="<?php echo $value->int; ?>"><?php echo $value->name; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
            <div class="row-fluid">
                ...
                <div class="span4">
                    <input name="phone" type="text" id="phone" class="input-block-level" value=""/>
                </div>
