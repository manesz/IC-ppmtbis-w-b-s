...
<script>
    ...
    var pathImageUpload = "upload/images/site_config/";
        ...
        <div class="block-content collapse in">
            <form id="formPost" name="formPost" method="post" action="">
                <div class="row-fluid">
                    ...
                    <div class="span8"><input name="site_title" type="text" id="site_title" class="input-block-level"
                                              value="<?php echo $site_title; ?>"/></div>
                </div>
                <div class="row-fluid">
                    <div class="span4">Site Description</div>
                    <div class="span8"><textarea name="site_description" id="site_description" class="input-block-level"
                                                 rows="10"><?php echo $site_description; ?></textarea></div>
                </div>
                <div class="row-fluid">
                    <div class="span4">Site Keyword</div>
                    <div class="span8"><textarea name="site_keyword" id="site_keyword" class="input-block-level"
                                                 rows="10"><?php echo $site_keyword ?></textarea></div>
                </div>
                <div class="row-fluid">
                    <div class="span4">facebook Account</div>
                    <div class="span8"><textarea name="facebook_account" id="facebook_account" class="input-block-level"
                                                 rows="10"><?php echo $facebook_account; ?></textarea></div>
                </div>
                <div class="row-fluid">
                    <div class="span4">twitter Account</div>
                    <div class="span8"><textarea name="twitter_account" id="twitter_account" class="input-block-level"
                                                 rows="10"><?php echo $twitter_account; ?></textarea></div>
                </div>
                <div class="row-fluid">
                    <div class="span4">Front Content</div>
                    <div class="span8"><textarea name="front_content" id="front_content" class="input-block-level"
                                                 rows="10"><?php echo $front_content; ?></textarea></div>
                </div>
                <div class="row-fluid">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span8"><textarea name="contact_content" id="contact_content" class="input-block-level"
                                                 rows="10"><?php echo $contact_content; ?></textarea></div>
                </div>
                <div class="row-fluid">
                    <div class="span4">Contact Phone</div>
                    <div class="span8"><input name="contact_phone" type="text" id="contact_phone"
                                              class="input-block-level" value="<?php echo $contact_phone; ?>"/></div>
                </div>
                <div class="row-fluid">
                    <div class="span4">Contact fax</div>
                    <div class="span8"><input name="contact_fax" type="text" id="contact_fax" class="input-block-level"
                                              value="<?php echo $contact_fax; ?>"/></div>
                </div>
                <div class="row-fluid">
                    <div class="span4">Contact email</div>
                    <div class="span8"><input name="contact_email" type="text" id="contact_email"
                                              class="input-block-level" value="<?php echo $contact_email ?>"/></div>
                </div>
                <div class="row-fluid">
