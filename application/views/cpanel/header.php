            ...
            <div class="nav-collapse collapse">
                <ul class="nav pull-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="divider"></li>
                            <li>
                                <a tabindex="-1" href="<?php echo($webUrl . 'cpanel/logout'); ?>">Logout</a>
                            </li>
                        </ul>
                    </li>
                </ul>
                <!--<ul class="nav">
                    ...
                    <li <?php echo $selectBar == "navigator" ? 'class="active"' : "" ?> >
                        <a href="<?php echo $webUrl; ?>cpanel/navigator">Navigator</a>
                    </li>
                    <li <?php echo $selectBar == "slide" ? 'class="active"' : "" ?> >
                        <a href="<?php echo $webUrl; ?>cpanel/slide">Slide</a>
                    </li>
                    <li <?php echo $selectBar == "page" ? 'class="active"' : "" ?> >
                        <a href="<?php echo $webUrl; ?>cpanel/page">Page</a>
                    </li>
                    <li <?php echo $selectBar == "post" ? 'class="active"' : "" ?> >
                        <a href="<?php echo $webUrl; ?>cpanel/post">Post</a>
                    </li>
                    <li <?php echo $selectBar == "user" ? 'class="active"' : "" ?> >
                        <a href="<?php echo $webUrl; ?>cpanel/user">User</a>
                    </li>
                    <li <?php echo $selectBar == "site_config" ? 'class="active"' : "" ?> >
                        <a href="<?php echo $webUrl; ?>cpanel/site_config">Site Config</a>
                    </li>
                    <!--                    <li class="dropdown">-->
