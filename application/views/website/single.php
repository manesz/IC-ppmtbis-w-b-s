...
$siteConfig = $this->CPanel_model->site_configList(1);
?>
...
<div class="fullwidth-container" style="position: relative;float: left; height: 110px; width: 100%;height: 110px;background: white;">
    <div class="container container-border"  style='border-top: 1px solid #ededed;'>
        <div class="pageTitle sixteen columns"  style='margin-top: 0px;'>
            <h3 class="page_title nine columns" style="color: #444444; font-size: 18px"><?php echo $arrData->title; ?></h3>
            <div class="entry-breadcrumb no-flicker seven columns" style="  border: none; color: #444444; font-size: 18px">
                <p style="float: right;">You are here: <a href="#">PROMPTBIS</a> » <a href="#" title="<?php echo $arrData->title; ?>"><?php echo $arrData->title; ?></a></p>
            </div>
...
<!--            <div class='des-sc-dots-divider'></div>-->
            ...
            <div>
                <form id="frmApplyJob" action="" method="post">
                    <input type="hidden" name="titleAJ" id="titleAJ" value="<?php echo $arrData->title; ?>"/>
                    <input type="hidden" name="jobID" id="jobID" value="<?php echo $arrData->id; ?>"/>
                    <div class="container">
                    	<div class="three columns">Name:</div><div class="eight columns"><input name="nameAJ" id="nameAJ" type="text" maxlength="50" class="yourname txt corner-input"/></div>
                	</div><!-- END: Container -->
                    <div class="container">
                    	<div class="three columns">Email:</div><div class="eight columns"><input name="emailAJ" id="emailAJ" type="text" maxlength="50" class="yourname txt corner-input"/></div>
                    </div><!-- END: Container -->
                    <div class="container">
                    	<div class="three columns">Mobile:</div><div class="eight columns"><input name="mobileAJ" id="mobileAJ" type="text" maxlength="15" class="yourname txt corner-input"/></div>
                	</div><!-- END: Container -->
                	<div class="container">
                    	<div class="three columns">Description:</div><div class="eight columns"><textarea class="yourmessage textarea message corner-input"
                            id="descAJ" name="descAJ"></textarea></div>
                    </div><!-- END: Container -->
                    <!-- <label>Name: <input name="nameAJ" id="nameAJ" type="text" maxlength="50" class="yourname txt corner-input"/></label>
                    <label>Email: <input name="emailAJ" id="emailAJ" type="text" maxlength="50" class="yourname txt corner-input"/></label>
                    <label>Mobile: <input name="mobileAJ" id="mobileAJ" type="text" maxlength="15" class="yourname txt corner-input"/></label>
                    <label>Description: <textarea class="yourmessage textarea message corner-input"
                            id="descAJ" name="descAJ"></textarea></label> -->
                </form>
                    ...
                    <script id="template-download" type="text/x-tmpl">
                        ...
                        <tr class="template-download fade">
                            ...
                            <td class="name">
                                ...
                                <input type="hidden" class="fileUp" value="<?php echo $baseUrl; ?>{%=file.url%}"/>
                            </td>
                            <td class="size">{%=o.formatFileSize(file.size)%}</td>
                            <td colspan="2"></td>
                            {% } %}
...
<!--                                                </button>-->
                    ...
                    <button class="btn btn-primary start" id="send-apply-job">Send</button>
                </div>

            </div>
            <!-- END: Apply Job Container -->
        </div>
    </div>
</section>
...
<script>
    $(document).ready(function(){
        var url = "<?php echo $webUrl; ?>apply_job/sendemail";
       $("#send-apply-job").click(function(){
           var data = {};
           var i = 0;
           ...
           $.post(url,
               {
                   file: data,
                   jobID: <?php echo $arrData->id; ?>,
                   category: '<?php echo $arrData->type_name; ?>',
                   jobName: '<?php echo $arrData->title; ?>',
                   nameAJ:$("#nameAJ").val(),
                   emailAJ:$("#emailAJ").val(),
                   mobileAJ:$("#mobileAJ").val(),
                   descAJ:$("#descAJ").val(),
                   sendTo: "<?php echo $siteConfig[0]->contact_email;?>"
               },
               function (result) {
                    alert(result);
               }
