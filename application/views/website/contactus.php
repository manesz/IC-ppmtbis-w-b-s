...
<?php
$expStrGmap = explode(',', $arrData->contact_lat_long);
?>
<input type="hidden" id="gm_lat" value="<?php echo empty($expStrGmap[0]) ? '13.7500' : $expStrGmap[0]; ?>"/>
<input type="hidden" id="gm_lng" value="<?php echo empty($expStrGmap[1]) ? '100.4833' : $expStrGmap[1]; ?>"/>
