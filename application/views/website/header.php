...
<head>
    ...
    Theme:      Freshlook HTML Vs1.0.3
    Author:		Designare
    Support:    http://support.designarethemes.com/
    Portfolio:  http://themeforest.net/user/Designare

    -->
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
    <title>Freshlook | Clean &amp; Fresh HTML</title>
...
<div class="logo five columns">
    <a href="index.html" tabindex="-1" style="text-indent: 0px;">
        <h1 class="logo" style="top: 24px; left: 0px; background: none; font-size: 12px;">Fresh<span class=color_logo>look</span>
        </h1>
    </a>

    <div class="slogan"
         style="background: none; font-family: 'Georgia'; font-style: italic; font-size: 12px; color: #cccccc;">Clean
        &amp; Fresh HTML
    </div>
</div>
...
<div id="slider_container">
    <?php include "front-image-slide.php" ?>
</div>
<!-- END: CAMERA SLIDER -->
