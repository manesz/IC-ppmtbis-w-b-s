        ...
        <div class="camera_caption">
            <div class="container" style="display:none; opacity: 0; filter: alpha(opacity=0);">
                ...
                <div class="eight columns" style="text-align: left; height: 100%;">
                    ...
                    <div class="title des_moveFromTop"><h1>Payroll Services</h1></div>

                    <div class="text des_moveFromBottom">PROMPT has the capacity and expertise to provide full payroll services to your employees.   We can take away the added pressure that the staff can put on your company administration.</div>
                </div>
        ...
        <div class="camera_caption">
            <div class="container" style="display:none; opacity: 0; filter: alpha(opacity=0);">
                ...
                <div class="eight columns" style="text-align: left; height: 100%;">
                    ...
                    <div class="title des_moveFromRight"><h1>Work Permit / VISA</h1></div>

                    <div class="text des_moveFromLeft">PROMPT provides high quality legal professional services in applying Non-immigrant Visa and Work Permit for you.</div>
                </div>

                <div class="eight columns" style="height: 100%;">
                    <img class="image des_moveFromTop" src="http://designarethemes.com/themes/freshlookwp/wp-content/uploads/2012/11/img_desc31.png" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="camera_caption">
            <div class="container" style="display:none; opacity: 0; filter: alpha(opacity=0);">
                ...
                <div class="eight columns" style="text-align: left; height: 100%;">
                    ...
                    <div class="title des_moveFromBottom"><h1>Search and Selection</h1></div>

                    <div class="text des_moveFromBottom">PROMPT provides recruitment services throughout all levels of staff and management positions across all areas of business.</div>
                </div>

                <div class="eight columns" style="height: 100%;">
                    <img class="image des_fade" src="http://designarethemes.com/themes/freshlookwp/wp-content/uploads/2012/11/gril12.png" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="camera_caption">
            <div class="container" style="display:none; opacity: 0; filter: alpha(opacity=0);">
                ...
                <div class="eight columns" style="text-align: left; height: 100%;">
                    ...
                    <div class="title des_moveFromLeft"><h1>HR Consultant</h1></div>

                    <div class="text des_moveFromRight">PROMPT will be a partner to client in Human Resources service and support to maximize and achieve its business objectives.</div>
                </div>
